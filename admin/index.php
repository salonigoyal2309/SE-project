      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <div class="input-daterange" id="datepicker1">
            <input type="date" name="from_date" id="from_date" class="form-control datapicker" placeholder="From Date" />
            <span id="error_from_date" class="text-danger"></span>
            <br />
            <input type="date" name="to_date" id="to_date" class="form-control datapicker" placeholder="To Date" />
